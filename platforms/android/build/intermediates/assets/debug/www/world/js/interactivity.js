var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		...
		/*
		 ...
		 https://www.blue-tomato.com/en-US/products/?q=sup
		 http://www.danielleklaasen.com
		*/
		var pageOneButton = this.createWwwButton("http://www.kk.dk/erhvervshus", 0.2, {
			offsetX: -0.025,		//-0.25
			offsetY: -0.45, //-0.25
			zOrder: 1
		});
		...
		*/
		var pageOne = new AR.Trackable2DObject(this.tracker, "poster1", {
			drawables: {
		...
		*/
		var pageTwo = new AR.Trackable2DObject(this.tracker, "poster2", {
			drawables: {
				cam: [overlayOne, pageOneButton]
			}
		});
	...
	worldLoaded: function worldLoadedFn() {
		...
		document.getElementById('loadingMessage').innerHTML =
			"<div" + cssDivInstructions + ">Scan Poster:</div>" +
			"<div" + cssDivSurfer + "><img src='assets/poster1.png'></img></div>" +
			"<div" + cssDivBiker + "><img src='assets/poster2.png'></img></div>";
